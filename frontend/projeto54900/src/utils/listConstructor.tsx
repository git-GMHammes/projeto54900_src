// Motor genérico do "Construtor de Listas" (list_manager/list_columns/
// list_actions — ver README_list_constructor.md). Extraído de
// ListConstructorPage.tsx pra ser reaproveitado por qualquer página que
// queira consumir uma listagem definida no banco em vez de colunas fixas no
// código — primeiro consumidor real: FormConstructorListPage.tsx.
//
// O QUE FICA AQUI: tipos, normalização das linhas cruas da API, resolução de
// célula (concat_json/fallback), tratamento especial por coluna
// (list_columns.format -> CUSTOM_CELL_RENDERERS) e avaliação de
// business_rule_json. Tudo puro (sem estado React) — cada página decide
// como buscar os dados e como reagir a clique em ação (preview vs navegação
// real), só o "o que renderizar" é compartilhado.
