// Lista de dados de usuarios (user_profiles via view_user_manager), menu
// "Dados Usuário" — consome o motor generico do "Construtor de Listas"
// (list_manager/list_columns/list_actions, slug 'user-profiles'), o mesmo
...
function ActionButton({
  ...
  const tip = `${action.label}${subject ? `: ${subject}` : ''}${disabled ? ' (indisponível)' : ''}`;
