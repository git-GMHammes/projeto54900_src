...
namespace App\Services\V1\Agenda\CalendarEvents;

use App\Models\V1\Agenda\Calendars\SqlTableModel as CalendarsModel;
use App\Models\V1\Agenda\CalendarEvents\SqlTableModel;
use App\Services\V1\BaseTableService;

/**
 * Service de negocio do modulo Agenda/CalendarEvents.
 *
 * CRUD generico vem de BaseTableService. Este Processor:
 *  - valida a existencia de calendar_id (FK ativa em calendars)
...
class Processor extends BaseTableService
{
    ...
    private CalendarsModel  $calendarsModel;
    ...
    public function __construct()
    {
        ...
        $this->calendarsModel = new CalendarsModel();
    }
    ...
    protected function validateOnCreate(array $data): ?array
    {
        ...
        if ($calendarId < 1 || !$this->calendarsModel->find($calendarId)) {
