...
namespace App\Services\V1\List\ListActions;

use App\Models\V1\List\ListActions\SqlTableModel;
use App\Models\V1\List\ListManager\SqlTableModel as ListManagerModel;
use App\Services\V1\BaseTableService;

/**
 * Service de negocio do modulo List/ListActions.
 *
 * CRUD generico vem de BaseTableService. Este Processor:
 *  - valida a existencia do list_manager_id (FK ativa)
 *  - serializa as colunas JSON (extra_data_json, business_rule_json) quando
 *    chegam como array/objeto
 *
