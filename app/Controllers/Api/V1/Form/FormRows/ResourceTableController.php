...
namespace App\Controllers\Api\V1\Form\FormRows;

use App\Controllers\Api\V1\BaseResourceTableController;
use App\Requests\V1\Form\FormRows\CreateRequest;
use App\Requests\V1\Form\FormRows\UpdateRequest;
use App\Services\V1\Form\FormRows\Processor;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

/**
 * Controller de recurso para operacoes diretas na tabela form_rows.
 *
