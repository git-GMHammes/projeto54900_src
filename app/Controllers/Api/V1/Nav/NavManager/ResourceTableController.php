...
namespace App\Controllers\Api\V1\Nav\NavManager;

use App\Controllers\Api\V1\BaseResourceTableController;
use App\Requests\V1\Nav\NavManager\CreateRequest;
use App\Requests\V1\Nav\NavManager\UpdateRequest;
use App\Services\V1\Nav\NavManager\Processor;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

/**
 * Controller de recurso para operacoes diretas na tabela nav_manager.
 *
