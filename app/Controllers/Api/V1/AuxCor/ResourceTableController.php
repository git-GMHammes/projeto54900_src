...
namespace App\Controllers\Api\V1\AuxCor;

use App\Controllers\Api\V1\BaseResourceTableController;
use App\Requests\V1\AuxCor\CreateRequest;
use App\Requests\V1\AuxCor\UpdateRequest;
use App\Services\V1\AuxCor\Processor;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

/**
 * Controller de recurso para operacoes diretas na tabela aux_cor.
 *
