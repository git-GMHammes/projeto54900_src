...
/**
 * Recria TODO o schema do banco a partir do dump SQL puro de 2026-09-23
 * (202609231655_replace_table.sql — DROP TABLE IF EXISTS + CREATE TABLE IF
 ...
 *
 * O dump de 2026-09-23 nao traz `CREATE DATABASE` / `USE`; o filtro fica
 ...
 * de proposito.
 */
class ReplaceTable20260923 extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609231655_replace_table.sql');
    }
