...
class CreateCalendarEventsTableMigration extends Migration
{
    public function up()
    {
        ...
        $this->forge->addForeignKey('calendar_id', 'calendar_manager', 'id', 'CASCADE', 'CASCADE', 'calendar_events_calendar_id_foreign');
        $this->forge->addForeignKey('recurring_event_id', 'calendar_events', 'id', 'CASCADE', 'SET NULL', 'calendar_events_recurring_event_id_foreign');
