 ...
 * 2026-09-22 (202609222142_create_view.sql — DROP VIEW IF EXISTS + CREATE
 * VIEW de cada uma; conteudo identico ao de 202609201819_create_view.sql).
 *
 * Mesmo padrao de 2026-09-20-181900_CreateView.php. Roda por ultimo — views
 * dependem das tabelas ja existirem (ReplaceTable20260922). Sufixo no nome da
 * classe pra nao colidir com CreateView.
 */
class CreateView20260922 extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609222142_create_view.sql');
    }
