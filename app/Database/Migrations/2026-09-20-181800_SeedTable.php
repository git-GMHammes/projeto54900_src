...
/**
 * Popula TODAS as tabelas com o estado de dados de 2026-09-20 a partir de um
 * dump SQL puro (202609201818_seed_table.sql — export completo, so INSERT).
 *
 ...
 * Forge/Model. Roda depois de ReplaceTable (tabelas precisam existir antes).
 *
...
class SeedTable extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609201818_seed_table.sql');
    }
