...
/**
 * Popula TODAS as tabelas com o estado de dados de 2026-09-24 a partir de um
 * dump SQL puro (202609241713_seed_table.sql — export completo, DELETE + INSERT).
 *
 ...
 * Forge/Model. Roda depois de ReplaceTable20260924 (tabelas precisam existir
 * antes). Sufixo no nome da classe pra nao colidir com SeedTable.
 *
 * down() nao tem reversao generica — fica vazio de proposito.
 */
class SeedTable20260924 extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609241713_seed_table.sql');
    }
