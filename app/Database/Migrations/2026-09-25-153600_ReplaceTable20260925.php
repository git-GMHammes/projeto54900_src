...
/**
 * Recria TODO o schema do banco a partir do dump SQL puro de 2026-09-25
 * (202609251536_replace_table.sql — DROP TABLE IF EXISTS + CREATE TABLE IF
 * NOT EXISTS de todas as tabelas reais, mais `migrations`).
 *
 * Mesmo padrao de 2026-09-24-171200_ReplaceTable20260924.php. Sufixo no nome
 * da classe pra nao colidir com ReplaceTable (mesmo namespace).
 *
 * O dump de 2026-09-25 nao traz `CREATE DATABASE` / `USE`; o filtro fica
 ...
 * de proposito.
 */
class ReplaceTable20260925 extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609251536_replace_table.sql');
    }
