...
/**
 * Recria TODO o schema do banco a partir do dump SQL puro de 2026-09-22
 * (202609222140_replace_table.sql — DROP TABLE IF EXISTS + CREATE TABLE IF
 ...
 *
 * O dump de 2026-09-22 traz `CREATE DATABASE` + `USE codeigniter54900_db`
 * fixos; esses statements sao ignorados pra migration rodar no banco
 * configurado em .env/Database.php, nao num nome cravado no .sql.
 *
 * down() nao tem inverso generico pra um DROP+CREATE em bloco -- fica vazio
 * de proposito.
 */
class ReplaceTable20260922 extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609222140_replace_table.sql');
    }
