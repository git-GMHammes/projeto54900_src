...
CREATE DATABASE IF NOT EXISTS `codeigniter54900_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `codeigniter54900_db`;
...
CREATE TABLE IF NOT EXISTS `form_fields` (
  ...
  `field_type` enum('text','password','email','textarea','senha','select','radio','checkbox','cpf','cnpj','phone','cep','data','hora','moeda','pis','placa','titulo','cnh','processo','renavam','sei','datahora') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'text',
...
CREATE TABLE IF NOT EXISTS `list_actions` (
  ...
  `action_type` enum('link','api_call','modal') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'link',
