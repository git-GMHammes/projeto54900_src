 ...
 * 2026-09-24 (202609241714_create_view.sql — DROP VIEW IF EXISTS + CREATE
 * VIEW de cada uma; em relacao a 202609231657_create_view.sql, a
 * view_user_manager ganhou ur_role_id e ur_role_description).
 *
 * Mesmo padrao de 2026-09-20-181900_CreateView.php. Roda por ultimo — views
 * dependem das tabelas ja existirem (ReplaceTable20260924). Sufixo no nome da
 * classe pra nao colidir com CreateView.
 */
class CreateView20260924 extends Migration
{
    public function up()
    {
        $this->executeSqlFile(__DIR__ . '/202609241714_create_view.sql');
    }
